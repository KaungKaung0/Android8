...
class HeadlineList extends State<ListState> {
  ...
  int page = 1;
  void getPage(currentPage, totalPage) {
    page = currentPage;
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        builder: (context, AsyncSnapshot<HeadlineModel> snapshot) {
          if (snapshot.hasData) {
            getPage(snapshot.data.page, snapshot.data.totalpage);
